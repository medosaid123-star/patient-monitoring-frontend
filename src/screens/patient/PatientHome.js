        ...
        <View style={styles.PAlertsContainer}>
          <View style={styles.PAlertsTextContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate("PAlerts")}
            >
        ...
        <View style={styles.featuresContainer}>
          <View style={styles.featuresGrid}>
            <View style={styles.featuresRow}>
              ...
              <TouchableOpacity
                style={styles.featureButton}
                onPress={() => navigation.navigate("PDiseaseChecker")}
              >
            ...
            <View style={styles.featuresRow}>
              <TouchableOpacity
                style={styles.featureButton}
                onPress={() => navigation.navigate("PHospitalLocator")}
              >
                <MaterialCommunityIcons
              ...
              <TouchableOpacity
                style={styles.featureButton}
                onPress={() => navigation.navigate("PDoctorLocator")}
              >
                <MaterialIcons
            ...
            <View style={styles.featuresRow}>
              <TouchableOpacity
                style={styles.featureButton}
                onPress={() => navigation.navigate("PVideoCall")}
              >
                <MaterialIcons
