...
const PChosenMedicine = ({ navigation, route }) => {
  ...
  const handleInfo = () => {
    navigation.navigate("PMedicineInfo", { medicine: safeMedicine });
  };

  const handleEdit = () => {
    navigation.navigate("PEditMedicine", { medicine: safeMedicine });
  };
...
export default PChosenMedicine;
