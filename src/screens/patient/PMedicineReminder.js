    ...
    <FontLoader>
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          {/* Add Medicine Button */}
          <TouchableOpacity
            style={styles.PAddMedicineButton}
            onPress={() => navigation.navigate("PAddMedicine")}
          >
            <MaterialIcons
              name="medication-liquid"
              size={width * 0.15}
              color={Colors.lightText}
              style={styles.PAddMedicineIcon}
            />
            <Text style={styles.PAddMedicineText}>Add Medicine</Text>
          </TouchableOpacity>
              ...
              <View key={rowIndex} style={styles.medicinesRow}>
                {row.map((card) => (
                  <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("PChosenMedicine", { medicine: card })}
                  >
                    <View style={styles.PMedicineInfo}>
                      <MaterialCommunityIcons
                        name="pill"
                        size={width * 0.08}
                        color={Colors.Accent}
