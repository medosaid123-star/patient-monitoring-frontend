...
const CPrivacy = ({ navigation }) => {
  ...
  const handleCChangeEmail = () => {
    navigation.navigate('CChangeEmail');
  };

  const handleChangePassword = () => {
    navigation.navigate('CChangePassword');
  };
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.title}>CPrivacy</Text>
          </View>
