        ...
        <View style={styles.featuresContainer}>
          <View style={styles.featuresGrid}>
            ...
            <View style={styles.featuresRow}>
              ...
              <TouchableOpacity
                style={styles.featureButton}
                onPress={() => navigation.navigate('CPDiseaseChecker')} // Updated navigation
              >
            ...
            <View style={styles.featuresRow}>
              <TouchableOpacity
                style={styles.featureButton}
                onPress={() => navigation.navigate('CHospitalLocator')} // Updated navigation
              >
                <MaterialCommunityIcons
              ...
              <TouchableOpacity
                style={styles.featureButton}
                onPress={() => navigation.navigate('CDoctorLocator')} // Updated navigation
              >
                <MaterialIcons
