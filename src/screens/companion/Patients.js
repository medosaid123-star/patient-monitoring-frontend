...
export default function EmergencyContacts({ navigation, route }) {
  ...
  const renderContact = ({ item }) => (
	<TouchableOpacity
	  ...
	  onPress={() => navigation.navigate('PatientInfo', { contact: item })}
	>
  ...
  const renderHeader = () => (
	<View>
	  ...
	  >
		...
		/>
		<Text style={styles.addContactText}>Add Patient</Text>
	  </TouchableOpacity>
	</View>
  );
