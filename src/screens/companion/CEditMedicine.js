...
export default function CAddMedicine({ navigation }) {
        ...
        <View style={styles.bottomNavBar}>
          <View style={styles.navWrapper}>
            {[
              ...
              { name: "Medicine", icon: "pill", screen: "CMedicineReminder" },
              { name: "Account", icon: "person", screen: "CProfile" },
              { name: "Settings", icon: "settings", screen: "CSetting" },
            ].map((item, index) => (
              <TouchableOpacity
                key={item.name}
                style={[
                ...
                onPress={() =>
                  navigation.navigate(item.screen, {
                    role: item.screen === "Home" ? "companion" : undefined,
                  })
                }
              >
                {item.icon === "pill" ? (
